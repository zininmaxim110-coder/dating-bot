...
# Создаем engine в зависимости от типа БД
...
# ... остальной ваш код моделей и функций остается без изменений ...
...
def init_db():
    ...
    try:
        ...
        # Для Render: создаем SQLite как fallback
        if not DATABASE_URL.startswith('sqlite'):
            print("⚠️ Пробуем использовать SQLite...")
            engine_sqlite = create_engine("sqlite:///dating.db", connect_args={'check_same_thread': False})
